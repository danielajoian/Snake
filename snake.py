...
class Snake(tk.Canvas):
    def __init__(self):
        super().__init__(
            width=800, height=820, background="pink", highlightthickness=0
        )
    ...
    def create_objects(self):
        ...
        self.create_text(
            55, 12, text=f"Score: {self.score}", tag="score", fill="red", font=30
        )
        ...
        self.create_rectangle(7, 27, 793, 813, outline="red")
